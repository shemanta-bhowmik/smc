	  ...
	  <div class="card-body">
		<form method="post" enctype="multipart/form-data">
            <div class="form-group">
                ...
                <input type="text" name="name" id="name" class="form-control mb-3 mb-3" maxlength="100">
                <?= $errors['name'] ?? ''?>
            </div>
            <div class="form-group">
                <label for="email">Email address</label>
                <input type="email" name="email" id="email" class="form-control mb-3" maxlength="100" value="<?= htmlspecialchars($_POST['email'] ?? '')?>">
                <?= $errors['email'] ?? '' ?>
            </div>
            <div class="form-group">
                <label for="phone">Phone</label>
                <input type="tel" name="phone" id="phone" class="form-control mb-3 mb-3" maxlength="20" pattern="[0-9+\-\s]+" >
                <?= $errors['phone'] ?? '' ?>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <select name="role" id="role" class="form-control mb-3" require>
            ...
            <div class="form-group">
                ...
                <input type="text" name="class" id="class" class="form-control mb-3"  maxlength="50" placeholder="e.g. 10th Grade">
            </div>
            <?= $errors['class'] ?? ''?>
            <div class="form-group">
                <label for="photo">Profile Picture</label>
                <input type="file" name="photo" id="photo" class="form-control mb-3 file border p-2" accept="image/*" >
            </div>
            <div class="form-group">
                <label for="password">Password</label>
                <input type="password" name="password" id="password" class="form-control mb-3 p-2">
            </div>
            <?= $errors['password'] ?? ''; ?>
